      ...
      <section>
        <div style={{ backgroundColor: " #f2f4f5" }}>
          <div className="text-center py-5 fw-bold">
            <h1 className="display-6 fw-bold " style={{ "fontFamily": "Outfit " }}> Terms of service </h1>
          ...
          <div className="container py-5">
            <div className="container py-5">
              <div className="container mx-5">
                <h3 className=" text-center display-10 fw-bold fw-700 mt-5 fs-1" style={{ "fontFamily": "Outfit " }}>Terms of service</h3>
              </div>
              <div>
                <strong>OVERVIEW</strong>
                <br />
                <p>This website is operated by New 99. Throughout the site, the terms “we”, “us” and “our” refer to New 99. New 99
                ...
                <p>We reserve the right, but are not obligated, to limit the sales of our products
                  ...
                  for any product or service made on this site is void where prohibited.</p>
                <br />
                ...
                <br />
                <p>Any use by you of optional tools offered through the site is entirely
                ...
                <p>If, at our request, you send certain specific submissions (for example contest entries)
                  or without a request from us you send creative ideas, suggestions, proposals, plans, or other
                ...
                <p>We may, but have no obligation to, monitor, edit or remove
                  ...
                  intellectual property or these Terms of Service.You agree
                  that your comments will not violate any right of any
                  ...
                  libelous or otherwise unlawful, abusive or obscene
                  ...
                  yourself, or otherwise mislead us or third-parties as
                ...
                <br />
                <p>Occasionally there may be information on our site or in the Service that contains typographical errors, inaccuracies or
                  ...
                  information or cancel orders if any information in the Service or on any related website is inaccurate at any time without
                  prior notice (including after you have submitted your order).</p>
                <br />
                <p>We undertake no obligation to update, amend or clarify information in the Service or on any related website, including
                ...
                <br />
                <br />
                <p>Occasionally there may be information on our site or in the Service that contains typographical errors, inaccuracies
                  ...
                  amend or clarify information in the Service or on any related website, including without limitation, pricing
                  information, except as required by law. No specified update or refresh date applied in the Service or on any
                  related website, should be taken to indicate that all information in the Service or on any related website has
                ...
                <br />
                <p>In no case shall New 99, our directors, officers, employees, affiliates, agents, contractors, interns,
                  ...
                  way to your use of the service or any product, including, but not limited to, any errors or omissions
                  in any content, or any loss or damage of any kind incurred as a result of the use of the service or
                  any content (or product) posted, transmitted, or otherwise made available via the service, even if
                ...
                <p>You agree to indemnify, defend and hold harmless New 99 and our parent, subsidiaries, affiliates,
                ...
                <p>The failure of us to exercise or enforce any right or provision of these Terms of Service
                  ...
                  to, any prior versions of the Terms of Service).</p>
                <br />
                ...
                <p>These Terms of Service and any separate agreements whereby we provide you Services
                  shall be governed by and construed in accordance with the laws of Bangladesh.</p>
                <br />
                <br />
                <strong>SECTION 19 - CHANGES TO TERMS OF SERVICE</strong>
                <p>You can review the most current version of the Terms of Service at any time at this page.</p>
                <br />
                <p>We reserve the right, at our sole discretion, to update, change or replace any part of these Terms of Service by posting
                ...
                <br />
                <p>Questions about the Terms of Service should be sent to us at marino.themes@gmail.com.</p>
