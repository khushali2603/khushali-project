...
export default function Product1() {
  return (
    <div>
  <section>
        <ProductHead head="Product" data="C. v product"/>

        <div className="container">
          <div className="row py-5">
            <div className="col-lg-6 col-12">
              <img src="image/handmade-product_13_1024x1024.png" alt="mag" className="w-100"/>
              <ProductSlider/>             
            </div>
            <div className="col-lg-6 col-12">
              ...
              <div style={{borderBottom:" 2px solid #f6f4f2"}}>
                ...
                <h4 className="fw-bold">C. v product</h4>
                <div className="d-flex py-2">
                  <h3 className="fw-bold"><del className="text-muted">$85.00</del> <span style={{color:" #e66d6d"}}
                      className="px-1">$70.00</span></h3>
          ...
          <div className="container pb-5">
            <div className="row row-cols-lg-4 pt-5">
              ...
              <div className="banner-box ">
                <img src="image/handmade-product_13_1024x1024.png" alt="handcraft_1" className="d-block m-auto w-100"/>
              ...
              <div className="banner-box">
                <img src="image/home-juri_f8b3b0ae-20b0-4467-8a00-7ecf3c1e204d_1024x1024.jpg" alt="dhakna" className="d-block m-auto w-100"/>
                <div className="text-center py-3">
              ...
              <div className="banner-box">
                <img src="image/product_1_600x.png" alt="home-juri" className="d-block m-auto w-100"/>
                <div className="text-center py-3">
              ...
              <div className="banner-box">
                <img src="image/handmade-product_17_large.png" alt="gift" className="d-block m-auto w-100"/>
                <div className="text-center py-3">
