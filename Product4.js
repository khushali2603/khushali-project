...
export default function Product4() {
  return (
    <div>
      <section>
        <ProductHead head="Product" data="E. s product"/>


        <div className="container">
          <div className="row py-5">
            <div className="col-lg-6 col-12">
              <img src="image/handmade-product_17_large.png" alt="juri" className="w-100" />
              <ProductSlider />
            ...
            <div className="col-lg-6 col-12">
              ...
              <div style={{ borderBottom: " 2px solid #f6f4f2" }}>
                ...
                <h4 className="fw-bold">E. s product</h4>
          ...
          <div className="container">
            <div className="row row-cols-lg-4 pt-5">
              ...
              <div className="banner-box">
                <img src="image/product_1_600x.png" alt="gift" className="d-block m-auto w-100" />
